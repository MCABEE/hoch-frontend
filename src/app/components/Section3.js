...
function Section3() {
  return (
    <div className="w-full mt-6 md:mt-0  ">
      ...
      <p className="text-center text-sm md:text-base lg:text-2xl 3xl:text-[30px] px-6 sm:px-10 md:px-32 lg:px-50 lg:px-80  py-2 sm:py-8 leading-[14px] 3xl:leading-[39px]">
      ...
      <div className="w-full flex justify-center items-center">
        <button className="w-[200px] md:w-[350px] lg:w-[400px] h-[40px] lg:h-[60px] 3xl:h-[75px] bg-[#09B438] hover:bg-[#09b437cf] rounded-[5px] text-white text-sm md:text-base lg:text-xl 3xl:text-2xl mt-0 md:mt-3 lg:mt-5">
          MORE INFORMATION
        </button>
      </div>
      </div>
